...
func (h *rbacHandler) ListProviders(ctx context.Context) (*corev1alpha1.ProviderList, error) {
...
func (h *rbacHandler) GetProvider(ctx context.Context, name string) (*corev1alpha1.Provider, error) {
	// Add RBAC checks here if needed in the future
